...
export const getPermissionsList = (params: permissionsListType) => {
  return request.get<responseData>("/w1/manage/permissions/list", params);
};

// 新建权限
export const createPermissions = (data: createPermissionsType) => {
  return request.post<responseData>("/w1/manage/permissions/create", data);
};

// 更新权限
export const updatePermissions = (data: updatePermissionsType) => {
  return request.post<responseData>("/w1/manage/permissions/update", data);
};
